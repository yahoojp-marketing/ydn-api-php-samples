...
// common defines
//-----------------------------------------------------------------
define('API_VERSION', 'V201809');
define('API_NS',      'http://im.yahooapis.jp/V201809');
define('XMLSCHEMANS', 'http://www.w3.org/2001/XMLSchema-instance');

//-----------------------------------------------------------------
// location
//-----------------------------------------------------------------
define('LOCATION',    'sandbox.im.yahooapis.jp');  //for sandbox
//define('LOCATION',    'location.im.yahooapis.jp'); //for production
