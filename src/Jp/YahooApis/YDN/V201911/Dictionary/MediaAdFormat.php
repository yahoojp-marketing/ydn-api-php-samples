...
class MediaAdFormat
{
    ...
    /**
     * @var boolean $campaignBanner
     */
    protected $campaignBanner = null;
     ...
     * @param boolean $campaignBanner
     */
    public function __construct($adFormat, $width, $height, $size, $transparent, $logo, $thumbnail, $sizeTo, $maxWidth, $maxHeight, $aspectWidth, $aspectHeight, $staticImage, $aspect, $aspectRatio, $campaignBanner)
    {
    ...
    /**
     * @param string $adFormat
     * @return \Jp\YahooApis\YDN\V201911\Dictionary\MediaAdFormat
     */
     ...
     * @return \Jp\YahooApis\YDN\V201911\Dictionary\MediaAdFormat
     */
    public function setCampaignBanner($campaignBanner)
    {
      $this->campaignBanner = $campaignBanner;
      return $this;
    }
