...
class LocationService extends \Jp\YahooApis\YDN\AdApiSample\Util\Service
{
    ...
    private static $classmap = array (
      ...
      'get' => 'Jp\\YahooApis\\YDN\\V201903\\LocationService_sandbox.wsdl\\get',
      'LocationReturnValue' => 'Jp\\YahooApis\\YDN\\V201903\\LocationService_sandbox.wsdl\\LocationReturnValue',
      'getResponse' => 'Jp\\YahooApis\\YDN\\V201903\\LocationService_sandbox.wsdl\\getResponse',
    );
    ...
    public function __construct($wsdl = null, $endpoint = null, array $options = array())
    {
      ...
      if (!$wsdl) {
        $wsdl = 'https://ydn.yahooapis.jp/services/V201903/LocationService_sandbox?wsdl';
      }
